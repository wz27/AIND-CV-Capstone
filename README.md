...
This is my capstone project for the Udacity AI nanodegree, with specialisation in Computer Vision. I created a facial keypoint recognition using OpenCV for this project. 
